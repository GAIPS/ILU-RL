...
# from ilurl.flow.util import makexml, printxml, ensure_dir    #TODO: REMOVE
import os
...
class CityflowKernelNetwork(BaseKernelNetwork):
    ...
    def __init__(self, master_kernel, sim_params):
        ...
        if target_path is not None:
            self.cfg_path = Path(target_path) / 'config' / 'config.json'
            self.roadnet_path = Path(target_path) / 'config' /'roadnet.json'
            self.flow_path = Path(target_path) / 'config' / 'flow.json'
