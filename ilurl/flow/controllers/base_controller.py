...
class BaseController:
    ...
    Usage
    -----
    >>> from ilurl.flow.params import VehicleParams
    >>> from ilurl.flow.controllers import IDMController
    ...
    car_following_params : ilurl.flow.params.SumoCarFollowingParams
