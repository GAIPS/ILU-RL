...
class Env(gym.Env):
    ...
    * compute_reward
    ...
    Attributes
    ----------
    env_params : ilurl.flow.params.EnvParams
    ...
    def __init__(self,
        ...
        if self.sim_params.render in ['gray', 'dgray', 'rgb', 'drgb', True]:
            # raise ValueError('sim_params.render is no longer supported')
